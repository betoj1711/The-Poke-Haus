...
export function SiteHeader(){
  ...
  return <><header className="header shopHeader"><div className="container nav">
    ...
    <nav className="navlinks" aria-label="Main navigation"><Link href="/#shop">Shop</Link><Link href="/#why-us">Why Us</Link><Link href="/sell">Sell Cards</Link><Link href="/faq">FAQ</Link><Link href="/contact">Contact</Link></nav>
